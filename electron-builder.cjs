...
module.exports = {
  ...
  mac: {
    ...
    extendInfo: {
      ...
      NSMicrophoneUsageDescription:
        "cirax transcribes your microphone so it can help you in conversations.",
      NSCameraUsageDescription: "cirax does not use the camera.",
      NSAudioCaptureUsageDescription:
        "cirax captures system audio to transcribe the other participant in a call.",
    },
  },
  win: {
  ...
  // A per-user install with a visible directory step: cirax is a personal overlay,
