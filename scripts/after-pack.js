 ...
 *
 * Opt-in via CIRAX_BUNDLE_WHISPER=1. Preparing the runtime downloads a pinned
...
module.exports = async function afterPack(context) {
  if (!process.env.CIRAX_BUNDLE_WHISPER) {
    console.log('[cirax] Skipping the bundled whisper runtime (set CIRAX_BUNDLE_WHISPER=1 to include it).');
    return;
  }
