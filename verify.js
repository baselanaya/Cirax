...
const handlerPos = src.indexOf("cirax.on('stt:interim'");
...
const finalHandlerPos = src.indexOf("cirax.on('stt:final'");
...
const llmStartIdx = src.indexOf("cirax.on('llm:start'");
const llmTokenIdx = src.indexOf("cirax.on('llm:token'");
